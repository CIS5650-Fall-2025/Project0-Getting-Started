...
int main(int argc, char *argv[])
{
    ...
    thrust::device_vector<float> tZ(d_z, d_z + size);
    ...
    thrust::device_vector<float>::iterator new_end = thrust::remove_if(tZ.begin(), tZ.end(), greaterThanHalf());
    tZ.erase(new_end, tZ.end());
