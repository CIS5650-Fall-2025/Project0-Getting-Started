...
int main(int argc, char *argv[])
{
    ...
    const unsigned sizeX = 1024;
    const unsigned sizeY = 1024;
    ...
    // Device arrays
    const size_t sizeBytes = sizeX * sizeY * sizeof(float); 
    float *d_a, *d_b;
    ...
    std::cout << "***Device To Device Copy***" << std::endl;
    {
        ...
        dims.dimGrid = dim3(divup(sizeX, threadCountX), divup(sizeY, threadCountY), 1); 
