...
int main(int argc, char *argv[])
{
    ...
    const size_t byteSize = sizeof(float) * size;
    CUDA(cudaMalloc((void**)&d_x, byteSize));
    CUDA(cudaMalloc((void**)&d_y, byteSize));
    CUDA(cudaMalloc((void**)&d_z, byteSize));
    ...
    CUDA(cudaMemcpy(d_x, x, byteSize, cudaMemcpyHostToDevice));
    CUDA(cudaMemcpy(d_y, y, byteSize, cudaMemcpyHostToDevice));
    ...
    CUDA(cudaMemcpy(z, d_z, byteSize, cudaMemcpyDeviceToHost));
