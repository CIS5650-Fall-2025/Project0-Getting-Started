...
int main(int argc, char *argv[])
{
	...
	CUDA(cudaMalloc((void**)&d_x, size_in_bytes));
	CUDA(cudaMalloc((void**)&d_y, size_in_bytes));
	CUDA(cudaMalloc((void**)&d_z, size_in_bytes));
	...
	CUDA(cudaMemcpy(d_x, x, size_in_bytes, cudaMemcpyHostToDevice));
	CUDA(cudaMemcpy(d_y, y, size_in_bytes, cudaMemcpyHostToDevice));
    ...
    CUDA(cudaMemcpy(z, d_z, size_in_bytes, cudaMemcpyDeviceToHost));
